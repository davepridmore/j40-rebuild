...
- Loads the generated `j40_full_vehicle_scaffold_rev_b.FCMacro`.
...
The rebuild is source-file driven. The viewer page is only reference. Put the CC-BY Sketchfab ZIP or extracted mesh files in:
