...
Generated: 2026-05-30T15:22:54.011210+00:00
...
- Author: tonielpro520
- License: Creative Commons Attribution 4.0 (CC BY 4.0); author credit required; commercial use allowed
- License URL: http://creativecommons.org/licenses/by/4.0/
- Downloadable: yes
- Mesh stats from Sketchfab API: 96,681 vertices, 177,769 faces, 31 materials, 3 textures
...
Download the source archive while logged in, put the ZIP in `data/manual/cad/j40_reference_model/00_inbox/`, then rerun `python3 scripts/j40_cad_intake.py`.
