...
- `../rubber_recreation_rev_a/bump_stop_vehicle_measurement_control.dxf` / `.svg` - bump-stop May 29 sample, rubber through-hole, central fixture/channel, height, and vehicle-measurement control.
...
- Bump stops: height and May 29 removed-sample construction are controlled. Copy the broad rounded/tapered rubber body, two rubber through-holes, central fixture/channel interface, and flat strike area from the removed samples, then trace or reuse the metal fixture separately and confirm strike geometry on the vehicle.
