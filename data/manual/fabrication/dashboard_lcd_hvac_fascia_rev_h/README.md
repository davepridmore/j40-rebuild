...
> **SUPERSEDED FOR HVAC FABRICATION — updated 2026-08-02:** the active [Rev I V13 specification](../dashboard_lcd_hvac_fascia_rev_i/README.md) uses a compact two-takeoff evaporator and exactly two high outer/end occupant outlets, one at each fixed end. Its visual target retains the geometrically centred 9-inch LCD, OEM glovebox and speedometer, seven-selector-plus-hazard bank, purchased MOMO wheel, original-height silhouette and factory steering-column relief; V13 starts with the cluster in its installed-photo relationship immediately above the column shroud. The signed vehicle trace, not the rendering, controls exact geometry. Do not cut the Rev H V1-V4 apertures or order its four-branch duct package. Retain this package only as the LCD/control reference and historical four-outlet record.
