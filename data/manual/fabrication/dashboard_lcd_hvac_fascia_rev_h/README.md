...
> **SUPERSEDED FOR HVAC FABRICATION — 2026-08-01:** the active [Rev I V11 specification](../dashboard_lcd_hvac_fascia_rev_i/README.md) uses a compact two-takeoff evaporator and exactly two high outer/end occupant outlets, one at each fixed end. It retains the central 9-inch LCD, OEM glovebox and speedometer, seven-selector-plus-hazard bank, purchased MOMO wheel, original shallow dashboard height and factory steering-column relief; V11 places the cluster at its present vehicle height immediately above the column shroud. Do not cut the Rev H V1-V4 apertures or order its four-branch duct package. Retain this package only as the LCD/control reference and historical four-outlet record.
