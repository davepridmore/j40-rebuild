# Rev H rear-envelope fit audit — 2026-08-01
...
| M6 | Actual selector-head/label/sweep and contact-stack measurements; 1:1 V4-to-selector clearance proof ≥20 mm. |
| M7 | Four matched vent samples, retainer/neck measurements and confirmed end lands. |
| M8-M9 | Full-depth mock-up with all vents, ducts, LCD, controls, loom, retained components and full column/stalk sweep; V4 rear clearance proof ≥10 mm. |
