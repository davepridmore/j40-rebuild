...
This folder contains the original paired Rev H four-outlet studies and the later standalone Rev I studies. **The current owner-selected geometric baseline is Rev I V22 and the switch-appearance reference is V18:** exactly two high outer/end outlets, the original Toyota speedometer and large asymmetric glovebox, a deleted/closed-over ashtray, a 9-inch LCD equidistant between the glovebox and cluster, the purchased MOMO wheel, the original-height visual target, the factory steering-column relief and the complete compact seven-selector-plus-hazard bank. V22 retains V21's common glovebox/LCD/speedometer datum and provisional approximately 25 mm rightward glovebox shift, then raises and horizontally aligns the complete wheel/boss/visible-column assembly to the unchanged factory opening axis. The opening itself remains controlled by the direct vehicle trace. V18 replaced the generic switch artwork with a closer representation of the received round chrome-ring, black-paddle XB4 controls without square legend plates. V15 begins with the intact cluster-to-column relationship shown in the installed owner photograph and the scallop shown in the straight-on bare-shell photograph; it does not translate the cluster to make room for the screen. V9–V14 are superseded design history; the unpublished V14 intermediate was rejected because it retained the ashtray as if it were a second glovebox. The controlled current package, V22 image and space audit are in the [Rev I specification](../../dashboard_lcd_hvac_fascia_rev_i/README.md).
