...
- `B-60010-LONG`: Do not use decayed rubber as the master. Measure the supplied one-piece flat metal backing/saddle plate outline, thickness, hole pitch, hole/thread size, bond face, vehicle bracket fit, strike-pad offset, loaded gap, and safe near-full-bump clearance.
- `B-60020-SHORT`: Do not use decayed rubber as the master. Measure the supplied one-piece flat metal backing/saddle plate outline, thickness, hole pitch, hole/thread size, bond face, vehicle bracket fit, strike-pad offset, loaded gap, and safe near-full-bump clearance.
- `B-60010-REAR-PAIR`: Do not use decayed rubber as the master. Measure the supplied one-piece flat metal backing/saddle plate outline, thickness, hole pitch, hole/thread size, bond face, vehicle bracket fit, strike-pad offset, loaded gap, and safe near-full-bump clearance.
