...
- `B-60010-LONG`: Do not use decayed rubber as the master. Measure vehicle bracket landing length/width, bolt/stud pitch, bolt/stud diameter or head clearance, relaxed rubber hole/slot size needed for stretch-fit installation, strike-pad offset, loaded gap, and safe near-full-bump clearance.
- `B-60020-SHORT`: Do not use decayed rubber as the master. Measure vehicle bracket landing length/width, bolt/stud pitch, bolt/stud diameter or head clearance, relaxed rubber hole/slot size needed for stretch-fit installation, strike-pad offset, loaded gap, and safe near-full-bump clearance.
- `B-60010-REAR-PAIR`: Do not use decayed rubber as the master. Measure vehicle bracket landing length/width, bolt/stud pitch, bolt/stud diameter or head clearance, relaxed rubber hole/slot size needed for stretch-fit installation, strike-pad offset, loaded gap, and safe near-full-bump clearance.
