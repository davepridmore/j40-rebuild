...
| --- | --- | --- | --- | --- |
| `dashboard_lcd_hvac_fascia_rev_a` | Dashboard / infotainment / A/C HVAC | Quote, vehicle template and prototype ready; vehicle cut and bought-part apertures held for measurement | `dashboard_lcd_hvac_fascia_rev_a/j40_dashboard_lcd_hvac_fascia_rev_a_dimension_sheet.pdf` | CNC main fascia and rear stiffener, removable 9-inch LCD and twin-vent carriers, industrial HVAC controls, DXFs, release schedule and photorealistic intent view. |
...
- `tools/generate_dashboard_lcd_hvac_fascia_rev_a.py`
