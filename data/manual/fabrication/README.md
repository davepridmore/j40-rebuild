...
| --- | --- | --- | --- | --- |
| `dashboard_lcd_hvac_fascia_rev_d` | Dashboard / infotainment / A/C HVAC | Quote, vehicle template and prototype ready; production cuts held for M1-M8 | `dashboard_lcd_hvac_fascia_rev_d/j40_dashboard_lcd_hvac_fascia_rev_d_shop_spec.pdf` | Corrected actual-photo RHD layout: the complete ashtray/radio zone becomes one flat face around a true 9-inch active-area reference. Exact selector map: right 2 x 2 = Wipers/Lights over Spots/Aux; under LCD = Blower, A/C Request, provisional Fuel Stop/Control; separate hazard and two hose-fed under-dash vents. Rev A-C are superseded. |
...
- `tools/generate_dashboard_lcd_hvac_fascia_rev_d.py`
