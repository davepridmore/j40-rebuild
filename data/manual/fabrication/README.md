...
| `battery_power_carrier_mount_rev_a` | Chassis fixing / electrical reset | Site-measurement hold for battery-side MIDI/cutoff carrier | `docs/front-engine-bay-mounting-fabrication-plan-20260508.md` | May 12 photos support tray-stand concept scouting; not a DXF release until ruler photos, battery mock-up, pickup points, and bonnet-clearance checks close. |
