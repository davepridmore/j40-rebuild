...
| `battery_power_carrier_mount_rev_a` | Chassis fixing / electrical reset | Site-measurement hold for battery-side MIDI/cutoff carrier | `docs/front-engine-bay-mounting-fabrication-plan-20260508.md` | Vehicle-side carrier/pickup plan; not a DXF release until battery tray and bonnet-clearance scouting closes. |
