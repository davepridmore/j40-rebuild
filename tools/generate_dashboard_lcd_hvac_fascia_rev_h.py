...
> **SUPERSEDED FOR HVAC FABRICATION — 2026-08-01:** the active Rev I V11 direction uses a compact two-takeoff evaporator and exactly two high outer/end occupant outlets, one at each fixed end, and retains the OEM cluster at its present vehicle height immediately above the column shroud. Do not cut the Rev H V1-V4 apertures or order its four-branch duct package. Retain this package only as the LCD, OEM glovebox/speedometer, control-bank and historical four-outlet design record; the Rev I production geometry remains on physical-measurement hold.
