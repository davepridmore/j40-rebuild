...
SCENES = {
    ...
    "relay_mount_rev_c": {
        ...
        "subtitle": "Fallback standalone relay-box carrier with rear guard and serviceable loom exit.",
        "camera": [380, 310, 460],
        "target": [0, 30, 0],
        "size": "360 x 255 mm carrier blank; 320 x 220 mm finished face; 280 x 185 mm rear guard",
        "load_path": "The folded carrier supports the DAIER relay/fuse box if the split relay route is used.",
        "service_intent": "Keep the rear guard spaced and the lower loom opening downward.",
        "boxes": [
            {"name": "Folded relay carrier face", "x": 0, "y": 3, "z": 0, "w": 320, "h": 8, "d": 220, "color": "aluminium"},
            {"name": "Side return", "x": -170, "y": -18, "z": 0, "w": 20, "h": 42, "d": 220, "color": "steel"},
            {"name": "Side return", "x": 170, "y": -18, "z": 0, "w": 20, "h": 42, "d": 220, "color": "steel"},
            {"name": "Bottom return", "x": 0, "y": -18, "z": 120, "w": 320, "h": 42, "d": 20, "color": "steel"},
    ...
    "electrical_modules_rev_a": {
        ...
        "subtitle": "Earlier reference route with relay tray, power module box, and rear insulator.",
        "camera": [430, 330, 520],
        "target": [0, 28, 0],
        "size": "Relay module tray plus power module box and rear insulator",
        "load_path": "Reference combined-module arrangement only; current release route is split/integrated elsewhere.",
        "service_intent": "Use this page for visual reference if the combined route is reopened.",
        "boxes": [
            {"name": "Relay tray face", "x": -150, "y": 3, "z": 0, "w": 320, "h": 8, "d": 220, "color": "aluminium"},
            {"name": "Relay box", "x": -150, "y": 50, "z": 0, "w": 250, "h": 64, "d": 150, "color": "black"},
            {"name": "Power module box face", "x": 160, "y": 3, "z": 0, "w": 220, "h": 8, "d": 140, "color": "aluminium"},
