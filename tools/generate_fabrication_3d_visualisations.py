...
def rubber_order_boxes(prefix: str = "Longman rubber") -> list[dict[str, object]]:
    return [
        ...
        {"name": f"{prefix} long bump-stop May 29 sample-style rubber body with through-holes", "x": -170, "y": 35, "z": 150, "w": 92, "h": 70, "d": 54, "color": "rubber", "shape": "rounded_rect", "corner_r": 10, "holes": [{"x": -32, "z": 0, "r": 6}, {"x": 32, "z": 0, "r": 6}], "label": "BUMP long H70", "label_dx": -72, "label_dy": -8},
        {"name": f"{prefix} long bump-stop central fixture channel marker", "x": -170, "y": 72, "z": 150, "w": 22, "h": 6, "d": 58, "color": "silver", "shape": "rounded_rect", "corner_r": 2},
        {"name": f"{prefix} short right-front May 29 sample-style rubber body with through-holes", "x": -45, "y": 30, "z": 150, "w": 88, "h": 60, "d": 50, "color": "rubber", "shape": "rounded_rect", "corner_r": 10, "holes": [{"x": -30, "z": 0, "r": 6}, {"x": 30, "z": 0, "r": 6}], "label": "BUMP short H60", "label_dx": 42, "label_dy": -8},
        {"name": f"{prefix} short right-front central fixture channel marker", "x": -45, "y": 62, "z": 150, "w": 20, "h": 6, "d": 54, "color": "silver", "shape": "rounded_rect", "corner_r": 2},
...
def rubber_order_item_images() -> list[dict[str, str]]:
    return [
        ...
        {
            "label": "BUMP long",
            "src": "photos/20260529_223605_gp_CklgF0cQ.jpg",
            "caption": "May 29 removed bump-stop face view",
        },
        {
            "label": "BUMP side",
            "src": "photos/20260529_223701_gp_wYPExcAA.jpg",
            "caption": "May 29 removed bump-stop side view",
        },
        {
            "label": "EXH hold",
...
SCENES = {
    "longman_rubber_order_20260508": {
        ...
        "subtitle": "Current supplier bundle: square body pads, two-hole front-support pad, underfloor strips, May 29 sample-style bump stops, and exhaust hold reference.",
        "camera": [430, 290, 470],
        "target": [-25, 32, 25],
        ...
        "height_callouts": [
            ...
            "BUMP long: 70 H sample style; BUMP short: 60 H sample style",
            "EXH hold target: 48 W x 86 H x 22 T",
        ],
        "load_path": "Rubber pads isolate body/front-support loads through flat parallel bearing faces; bump stops follow the May 29 removed-sample rubber through-holes, central fixture/channel interface, and vehicle-confirmed strike geometry.",
    ...
    "rubber_recreation_rev_a": {
        ...
        "load_path": "Body/front-support pads are released as solid automotive rubber first articles; hardware, sleeves, and cups are separate, while bump stops follow the May 29 removed-sample through-hole rubber layout, central fixture/channel interface, and vehicle-confirmed strike geometry.",
