...
def rubber_order_boxes(prefix: str = "Longman rubber") -> list[dict[str, object]]:
    return [
        ...
        {"name": f"{prefix} long bump-stop supplied flat steel backing plate", "x": -170, "y": 2, "z": 150, "w": 82, "h": 4, "d": 48, "color": "silver", "shape": "rounded_rect", "corner_r": 3, "holes": [{"x": -32, "z": 0, "r": 5}, {"x": 32, "z": 0, "r": 5}]},
        {"name": f"{prefix} long bump-stop bonded rubber body 70 H", "x": -170, "y": 39, "z": 150, "w": 70, "h": 70, "d": 40, "color": "rubber", "shape": "rounded_rect", "corner_r": 5, "label": "BUMP long H70", "label_dx": -64, "label_dy": -8},
        {"name": f"{prefix} short right-front supplied flat steel backing plate", "x": -45, "y": 2, "z": 150, "w": 78, "h": 4, "d": 46, "color": "silver", "shape": "rounded_rect", "corner_r": 3, "holes": [{"x": -30, "z": 0, "r": 5}, {"x": 30, "z": 0, "r": 5}]},
        {"name": f"{prefix} short right-front bonded rubber body 60 H", "x": -45, "y": 34, "z": 150, "w": 66, "h": 60, "d": 38, "color": "rubber", "shape": "rounded_rect", "corner_r": 5, "label": "BUMP short H60", "label_dx": 42, "label_dy": -8},
...
SCENES = {
    "longman_rubber_order_20260508": {
        ...
        "subtitle": "Current supplier bundle: square body pads, two-hole front-support pad, underfloor strips, supplied-flat-plate bump-stop placeholders, and exhaust hold reference.",
        "camera": [430, 290, 470],
        "target": [-25, 32, 25],
        ...
        "height_callouts": [
            ...
            "BUMP long: 70 H on flat plate; BUMP short: 60 H on flat plate",
            "EXH hold target: 48 W x 86 H x 22 T",
        ],
        "load_path": "Rubber pads isolate body/front-support loads through flat parallel bearing faces; bump stops bond/capture to the supplied one-piece flat backing plate with vehicle-confirmed hole pitch and strike geometry.",
    ...
    "rubber_recreation_rev_a": {
        ...
        "load_path": "Body/front-support pads are released as solid automotive rubber first articles; hardware, sleeves, and cups are separate, while bump stops bond/capture to the supplied one-piece flat backing plate with vehicle-confirmed holes and strike geometry.",
