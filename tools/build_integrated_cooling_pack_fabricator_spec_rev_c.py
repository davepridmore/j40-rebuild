...
def build_document():
    ...
    add_paragraph(document, "PH01 — Complete wide Rev G split visual. Read the main row from left to right as the installed front-to-rear order: centred twin Toyota/Denso electric-pusher module, short central charge cooler, condenser, engine radiator, then the sealed rear shroud and large retained mechanical puller. Uprights, rails, direct ears, lower saddles, drier, protected electrical enclosures, seals, connectors and fasteners are also separated for identification. Their exploded positions do not authorise side-by-side installed placement or extra width; PH05/D09 and E2/E2a control the electrical installation. This is an AI layout aid only; D01–D10, signed measurements, actual components and the accepted full-size dummy govern manufacture.", italic=True)
    ...
    add_picture(document, ASSET / "rev_g_ph03_complete_stack_cutaway_v2.png", 6.20)
    add_paragraph(document, "PH03 — Complete installation proposal on the authoritative bracket photo. The normal front portion shows the centred twin electric pushers and both original top-hole attachments. The controlled cutaway visibly accounts for the short charge cooler, condenser, engine radiator, sealed rear shroud and large engine-driven mechanical puller as separate depth layers. The rear fan remains centred behind the radiator and inside both uprights; the cutaway does not authorise side placement or extra width. At each side, follow the M8/washer stack through the original top-return hole and sleeved EPDM isolator into the independent black 4 mm ear, which continues directly to the radiator side rail; the lower saddle beneath that same rail carries weight. There is no transverse carrier or intermediate bracket. This AI image is illustrative only; the rigid two-hole template, B0/H0-L/H0-R/W0/P0/R0 measurements and full-size dummy govern fit.", italic=True)
