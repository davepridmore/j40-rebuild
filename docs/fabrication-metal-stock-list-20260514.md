...
| --- | --- | --- |
| `3.0 mm` mild-steel sheet/plate | 1 sheet at least `600 x 600 mm`; `1000 x 500` acceptable/preferred if similarly priced | Battery tray deck `340 x 265`, widened access-ladder flat face `660 x 310`, hold-down `340 x 38`, seated MIDI output comb/backplate support, relay left/top exit tabs, side-mounted kill-switch shelf tabs, small flat tabs/guards. |
| `3.0 mm` `90-degree` mild-steel angle/L-section | `25 x 25 x 3 mm` or `30 x 30 x 3 mm`, `3 m` total | Battery tray perimeter/upstands, widened access-ladder frame, shallow MIDI and side kill-switch shelf rails, seated MIDI output comb/gland support, relay left/top exit tabs, cable/P-clip tabs. |
