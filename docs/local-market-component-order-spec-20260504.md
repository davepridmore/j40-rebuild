...
| `BUMP-F-L` | Front left bump stop | `1` | Fabricate or source exact long molded rubber assembly. Toyota `48304-60010` controls the long-stop family and `70 mm` free height; public sources do not expose the Toyota mould drawing, so the May 31 exact front-stop photos control the visible shape. | Reproduce the May 31 front-stop broad rounded/tapered rubber body with two rubber through-holes, central fixture/channel interface, and flat strike area, made to the long height. Release rubber body outline, through-hole pitch `P`, hole/thread `D`, fixture/channel, strike-pad offset `X/Y`, loaded gap `G`, and full-bump clearance `F` from the front-stop sample/photos, removed fixture, vehicle bracket, and axle strike pad. | New automotive NR/SBR bump-stop rubber, Shore A `70 +/-5`, with sample-proven fixture/insert retention where present; cast PU Shore A `80 +/-5` only if the same shape, through-holes, fixture interface, and rebound recovery are held. | Fabricator must supply sketch/CAD, rubber through-hole layout, fixture/channel trace, material declaration, and one first article; it must align by hand, capture the fixture/channel without tearing or rocking, contact within `+/-5`, survive 50 percent compression, and engage before shock/tyre/spring/brake-hose limits; no simple cut block. |
| `BUMP-F-R` | Front right bump stop | `1` | Fabricate or source exact short molded rubber assembly. Toyota `48304-60020` controls the short right-front family and `60 mm` free height. | Exact May 31 front-stop rubber through-hole, central fixture/channel, tapered-body, and flat strike-face requirement at the short height, released from the right-front bracket and strike pad. Do not use the `70 mm` long-stop height here unless a full-bump test releases trimming. | Same compound family as left, but right-side geometry and height must stay distinct. | Reject aftermarket or locally made right-front stops at `70 mm` unless deliberately trimmed/released by vehicle full-bump check. |
| `BUMP-R` | Rear bump stops | `2` | Fabricate or source exact long molded rear/back rubber pair. Toyota `48304-60010` controls the long rear-stop family and `70 mm` free height. | Same May 31 front-stop rubber through-hole, central fixture/channel, tapered-body, and flat strike-face design made longer; release each rear bracket fit, through-hole pattern, fixture/channel, contact offset, loaded gap, and full-bump clearance from the front-stop sample/photos, fixture, rear vehicle brackets, and strike pads; rear pair height match `<=1`. | Matched rear NR/SBR bump-stop rubber pair, Shore A `70 +/-5`, with sample-proven fixture/insert retention where present; PU fallback only as a matched pair with proven same shape and rebound. | Check Ironman ride height and axle travel before mould release; reject simple blocks, universal stops, failed retention tests, or unmatched rear pair. |
