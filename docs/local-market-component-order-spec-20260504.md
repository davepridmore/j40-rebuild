...
| `PIPE-FUEL-01` | Low-pressure diesel feed hard line | `1` coil/length | New automotive bundy steel or CuNi/Cunifer tube to replace the old feed line. | Exact stock allowance: `8 mm OD x 5000 mm`; individual sections cut shorter from old route. | Copy old route, unions/end style, clips, pass-through protection, leak test. | Bare copper, plumbing tube, used line, unknown fitting style. |
...
| `HOSE-FUEL-01` | Low-pressure diesel feed hose | `3000 mm` | New diesel-rated hose, SAE J30R9 preferred; SAE J30R14T2 / DIN 73379-3E acceptable. | `8 mm ID`. | New rolled-edge fuel-injection clamps matched to selected hose OD. | Used hose, no diesel/fuel markings, coolant/vacuum hose, perforated clamp. |
