...
| `FS-STRIP-L` | Underfloor body-support strip liner, left | `1` | Plain flat rubber strip. | `165 L x 38 W x 8 T`; plan corners `R1.5`; top/bottom edge break `0.5-1.0`; no rubber holes by default. | Same mount-grade rubber. | Released for first article; dry-fit controls only local end trim and separate steel retainer trace. |
| `FS-STRIP-R` | Underfloor body-support strip liner, right | `1` | Same plain rubber blank as left unless dry-fit proves handed end trim. | `165 L x 38 W x 8 T`; plan corners `R1.5`; top/bottom edge break `0.5-1.0`; no rubber holes by default. | Same as left. | Released for first article; dry-fit controls only local end trim and separate steel retainer trace. |
