...
- `track_delivery` (8):
  ...
  - `part_daraz_nitrile_gloves_black_l_100pc_20260504` [P0] Safety Black Disposable Nitrile gloves 100 PCs Box - black large (price: 2333 PKR; order_date: 2026-05-04; delivery_eta: delivery_date_tbd; delivery_status: pending_delivery; payment_status: paid)
  - `part_chassis_masking_plugs_tape_solvent_wipes` [P0] Chassis coating masking pack - solvent-safe wipes, masking tape, thread/hole plugs (price: price_tbd; order_date: 2026-05-08; delivery_eta: delivery_date_tbd; delivery_status: pending_delivery; payment_status: paid)
  ...
  - `part_suspension_wooden_cribbing_blocks` [P1] Seasoned hardwood cribbing cut set - 8 blocks + 4 wedge chocks (price: price_tbd; order_date: 2026-05-04; delivery_eta: delivery_date_tbd; delivery_status: pending_delivery; payment_status: not_paid)
