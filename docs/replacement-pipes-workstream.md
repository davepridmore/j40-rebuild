...
| `RPO-COOL-004A/B` | EPDM heater hose, SAE J20R3 or better. Expected `16 mm / 5/8 in` ID unless measured nipples require another size. | `400 mm` inlet + `280 mm` outlet, or `1000 mm` stock to cut | Engine heater nipple OD, heater-core nipple OD, route lengths, clamp OD, rear-heater presence. | `COOL-C` |
...
| `RPO-COOL-006A/B` | Two EPDM coolant/radiator connector hoses for the formed pipe. Working `28-30 mm` ID until pipe/spigot OD is measured. Use straight hose only if it does not kink; otherwise match molded EPDM connector shape. | `2 x 500 mm` connector blanks, or `1000 mm` total stock | Pipe-end OD and bead, mating spigot OD, connector free/cut length, hose ID/OD, overlap, clamp band width, bend/kink clearance. | `COOL-D` |
...
| `RPO-VAC-001A` | Reinforced brake-booster/vacuum hose that will not collapse. | `10-12 mm ID x 2000 mm` | Cut on vehicle; confirm pump/booster/check-valve barb fit, check-valve direction, heat/chafe exposure, and brake-assist vacuum. | standard 2H basis |
| `RPO-VAC-001B` | Oil-resistant breather/oil-mist hose. | `16-19 mm ID x 1000 mm` | Cut on vehicle; confirm breather spigot fit, route length, oil exposure, heat/chafe exposure, and no oil swelling. | standard 2H basis |
...
### `COOL-B` Overflow Hose And Bottle Route

- `photos/20260503_153639_gp_ZueGlpJw.jpg`
- `photos/20260503_153647_gp_L54euoMQ.jpg`
- `photos/20260503_155956_gp_P4xfMJzw.jpg`

### `COOL-C` Heater Hose Firewall, Engine Ends, And Route
...
### `COOL-D` Formed Coolant Pipe, Connector Hoses, And Dry-Fit Context
...
- `photos/20260503_153031_gp_rFfqDUBw.jpg`
- `photos/20260503_153054_gp_uj94xuug.jpg`
- `photos/20260503_153130_gp_gkKoFapg.jpg`
- `photos/20260503_160050_gp_3aBjHmzw.jpg`
