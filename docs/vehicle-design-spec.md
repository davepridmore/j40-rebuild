...
- the true 9-inch/16:9 LCD remains centred on the usable fascia; the active Rev I V11 direction retains exactly two matched large directional A/C outlets high at the fixed outer/end regions, lowers the complete original cluster to its present vehicle position immediately above the steering-column shroud, deletes the Rev H inner/lower outlets and pods, and holds final fascia apertures and behind-dash geometry until the vehicle, bought louvers, compact two-takeoff evaporator and complete service envelope are physically measured
