...
- the replacement section carries the purchased Pioneer DMH-AP6650BT with its approximately 229 × 131 × 13 mm published front/nose flush with the panel. All panel-perimeter, speedometer-side termination, corner-radius, aperture, rear-mount, duct and position data remain HOLD pending physical traces, actual parts and a complete rear buck; the V44 appearance proposal is indexed by `data/manual/fabrication/dashboard_lcd_hvac_fascia_rev_i/README.md`
