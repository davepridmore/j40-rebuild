...
The as-fitted route scope is now part of the CAD workflow. Use [j40-digital-twin-as-fitted-cable-scope-20260531.md](j40-digital-twin-as-fitted-cable-scope-20260531.md), [j40-as-fitted-route-pakistan-purchase-bom-20260531.md](j40-as-fitted-route-pakistan-purchase-bom-20260531.md), `data/manual/cad/j40_reference_model/05_reports/j40_as_fitted_route_model_scope_20260531.csv`, and `data/manual/j40_as_fitted_route_pakistan_purchase_bom_20260531.csv` to drive every cable, loom, hose, hard line, control cable, earth strap, A/C hose, brake/fuel line, and drivetrain-orientation verification into named model geometry and Pakistan-local buy specs. Route placeholders are visual only until the actual truck supplies endpoints, pass-throughs, supports, bend radius, clearance measurements, and the relevant buy-item proof.
