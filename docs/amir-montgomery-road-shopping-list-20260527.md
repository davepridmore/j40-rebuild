...
| P-clips, U-clips, grommets, edge trim, caps/plugs, brake cleaner, catch tray, flare-nut wrenches | "Need small support/consumable stock: rubber-lined P-clips for `4.75 mm`, `6 mm`, `8 mm`; brake flex-hose U-clips; grommets `6/8/10/12 mm` and `16/20/25 mm`; edge trim; hydraulic caps/plugs; brake cleaner; catch bottle/tray/rags; metric flare-nut wrench set covering `10/11/12/14/17 mm`." | Pack/count/size photos, price, and one photo showing the clip/grommet beside a ruler. | Buy if size and quality are obvious and price sensible; if uncertain, photos/price only. |
