...
- Latest local Gmail import `data/processed/generated/comms_ingest_2026-05-29_categorized.csv`: `32` messages read, `18` categorized after `2026/05/27`.
...
| Brake booster / servo | "Quote professional rebuild of our old booster, or direct-match refurbished exchange. Do not quote a raw used booster. It must match firewall studs, master studs, pushrod/clevis, shell depth/diameter, check valve/grommet, and vacuum hold." | Videos required by `docs/amir-refurbishment-video-gates-20260529.md`: old sample identity, side-by-side match, interface close-ups, vacuum hold, assist movement, contamination check, final acceptance. | Quote freely; no deposit/payment/exchange until video gate is approved. |
...
| Brake tube nuts / unions / rear T | "Need brake-rated `3/16 in / 4.75 mm` double/inverted-flare tube nuts, inline unions, and rear T fitting for old Toyota. Thread and seat must match old sample. No plumbing/compression fittings." | Thread side, seat side, hex size, port arrangement, mounting hole/bracket, packet label, price. | Quote/photo only until old sample confirms thread and seat. |
| Rear drum and parking-brake hardware | "Need rear drum return springs, hold-down pins/cups/springs, adjuster hardware, retaining clips, parking-brake lever clips, clevis pins, equalizer/intermediate pieces, adjuster nut, cable-end clips, and return springs by opened-drum sample/layout and received cable." | Photos of each piece, dimensions, price, whether it duplicates the Centric kit or cable kit. | Buy only after opened-drum/received-cable sample/spec confirms missing pieces. |
...
| Receipt-check procured Amir items | "These are not new buys. Please verify what was already bought: M6 x120/M8 x60/M10 x30 star washers, 3 lb sledge, 25 ft 3/16 brake tube, Raptor hardener 1 L, Centric rear drum kit `116971-05110530`, Brighto Extreme Paint Remover 3 L, blow torch." | Receipt/packet photos, counts, labels, sizes, sealed/in-date condition, and safety/function check photos. | Mark as received-candidate only until spec/condition check passes. |
...
| <img src="amir_montgomery_real_images/brake_tee.jpg" width="110"> | Brake tee / inline unions / tube nuts | Use existing stock by old tee/union location | Brake tees/unions are on hand. Match old thread, flare seat, port orientation, mounting hole, and tube entry angles before use; quote only if no on-hand part matches. |
...
> Need 4.75 mm / 3/16 in automotive brake hard-line tube for old Toyota Land Cruiser. Prefer double-wall Bundy steel with zinc/PVF/galvanized coating. We already have P-clips, U-clips, and brake tees/unions; use them at the same original locations only if thread, seat, port orientation, bracket, hose groove, and line OD match. Quote tube nuts or a tee/union only if the on-hand stock does not match the old sample. No copper plumbing tube and no compression fittings.
