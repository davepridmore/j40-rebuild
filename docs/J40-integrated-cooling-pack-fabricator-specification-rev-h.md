...
## Pakistan fabricator specification — Rev H, Toyota-donor-led all-front package
...
## START HERE — what to buy, retain and fabricate

This is **not** a Prado radiator conversion or a catalogue direct-fit kit. The only Prado 120/GX470 donor items are **two matched Toyota/Denso front-fan motor, 248 mm blade and plug/pigtail sets**. Toyota part numbers below are search/identity references; every actual part must be measured and pass its release gate.

> **REV H — CONNECTION AND CENTRELINE CONTROL:** establish vehicle longitudinal centreline **C0** from paired chassis references and transfer it to the cooling aperture before making the fan shroud. The two equal front fan centres shall be **C0 − 133 mm** and **C0 + 133 mm**, at the same height within ±2 mm; their midpoint shall be within ±2 mm of C0. The installed pack has exactly **three cores and three fans**. It also has exactly **two radiator main coolant necks**, **two condenser refrigerant fittings** and **two charge-cooler ports**. These three pairs are different circuits and shall not be confused.

| Circuit | Exactly what must be visible and connected | Route |
|---|---|---|
| Engine coolant | 2 large radiator hose necks, plus filler/cap, small overflow nipple and lowest drain cock | Engine/thermostat outlet → upper radiator neck; lower radiator neck → water-pump inlet. The actual 2H hose route controls final side, angle and diameter |
| A/C refrigerant | 2 smaller condenser fittings; common basis #8 upper inlet and #6 lower outlet, subject to the physical sample | Compressor/high side → condenser inlet; condenser outlet → receiver-drier/expansion circuit. A/C technician confirms threads and routing |
| Turbo charge air | 2 × 57 mm beaded charge-cooler ports, one at each end | Turbo compressor discharge → cooler inlet; cooler outlet → engine intake manifold |
...
| **SOURCE NEW STANDARD — VERIFY STOCK** | 1 each + service hardware | Condenser **559 × 356 × 21 mm** with exactly two refrigerant fittings; charge cooler **500 × 180 × 50 mm** with exactly two 57 mm beaded charge-air ports; new drier **88471-34010** only if ports fit, otherwise new #6 O-ring equivalent; hoses, relays/connectors, M6/M8 hardware and EPDM | Use local A/C, turbo and automotive-hardware suppliers. Exact stock changes; every complete condenser/drier/cooler envelope and port remains **physical-sample first** |
...
> **PURCHASING STATUS:** source samples and make the measurement fixture now. Final radiator/core, final charge cooler/condenser, final fan purchase, bracket drilling and finish coating remain on HOLD until the stated physical-fit gates pass. Pakistan sourcing status describes the expected route, not guaranteed live stock or direct fit.

> **KARIGAR KE LIYE — SIMPLE RULE:** Pehle chassis se gaari ki beech wali line **C0** nikaal kar aperture par mark karein. Dono front fan hub C0 se barabar **133 mm** left/right hon; pair ko radiator ya fuse box dekh kar side par na karein. Teenon cores aik seedhi central line mein lagain: **front fans → intercooler → condenser → radiator → engine fan**. Kul **teen fans** hain: do electric pushers samnay aur aik engine-driven puller radiator ke peechay. Intercooler ke do 57 mm pipe sirf turbo-air ke hain; condenser ke do chhotay fitting A/C gas ke hain; radiator ke do baray neck engine-water hose ke hain, aur cap/overflow/drain alag hain. Radiator ka wazan neeche ke do saddles uthayen. Radiator ki apni left/right side rail se aik chhota 4 mm ka ear seedha har puranay top hole ke neeche aaye; beech mein koi cross-bar/carrier nahin. Dono M8 bolts haath se poori tarah lagain, radiator ko kheench kar line mein na layein. Relay aur fuse ke **do alag band dabbe**, do alag chhotay structural brackets aur apni apni rain hood par upper/rear lagain—radiator ya top-return brackets par nahin. Pehle **C0/B0/H0-L/H0-R/W0/P0/R0** naapain aur BRKT full-size dummy fit karein; final radiator us ke baad banayen.

## 1. Rev H decision

Rev H adopts a **best-effort, simple and clean-looking all-front cooling package** with Toyota/HJ47/Prado donor service parts wherever they actually fit and can prove the required duty. It replaces the Rev E side/wing charge-cooler system; the donor radiator and donor full shroud are not assumed to fit.
...
**Fan count: exactly three system fans in Rev H—two front electric pushers plus one rear engine-driven mechanical puller. Do not fit a third electric fan or any fourth fan in this release.**

- The radiator, condenser, charge cooler and both front fans remain inside the existing upright silhouette.
- The two electric fan centres are level and symmetric about surveyed vehicle centreline C0: **C0 − 133 mm / C0 + 133 mm**, with the midpoint within ±2 mm of C0 and fan heights matching within ±2 mm.
...
- two equal black fan rings, level and horizontally centred on vehicle C0—not on an offset core, bracket or accessory;
...
![PH01 — complete wide split-out of the Rev H cooling pack](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_g_ph01_complete_wide_exploded_v2.png)
...
![PH02 — off-vehicle Rev H central cooling module](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_g_ph02_toyota_donor_assembled.png)

PH02 intentionally omits the chassis posts and both electrical boxes. PH03C/PH04 alone illustrate the existing-hole radiator attachment; PH05/D09 and E2/E2a separately control the upper/rear electrical installation. This prevents an off-vehicle product image from implying a false frame connection or extra side packaging.

### 1.4 Normal opaque front-installed appearance

![PH03A — fully opaque Rev H cooling pack installed on the later J40 front structure](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_h_ph03a_interface_opaque_centered.png)

**What PH03A communicates:** this is the normal finished front appearance with the cores and shrouds fully opaque and no cutaway. It shows two equal electric pusher fans in a compact rectangular module between the existing uprights. The retained engine-driven mechanical puller is still fitted behind the radiator but is correctly hidden from this direction. PH03A is contextual only and is **not** the dimensional proof of C0 centring.

### 1.5 Fully opaque engine-side rear view

![PH03B — engine-side view of the retained mechanical puller and closed electrical enclosures](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_h_ph03b_opaque_engine_side_rear.png)

**What PH03B communicates:** looking forward from the engine bay, the one large retained Toyota 2H engine-driven puller is plainly visible and centred in its sealed full-face rear shroud. The copper/brass engine radiator is immediately in front of it. The two 248 mm electric pushers, charge cooler and condenser are on the grille side and are therefore correctly hidden by the fully opaque radiator. Both upper/rear electrical enclosures are shown closed; no fuse, holder or live stud is exposed. Do not derive exact fan diameter, hose routing, connector position or mounting dimensions from this illustrative render.

### 1.6 Controlled interface cutaway — centring, circuits and hidden layers

![PH03C — corrected Rev H package on the later J40 front structure, with the twin front-fan midpoint on vehicle C0](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_h_ph03_interface_cutaway_centered_final.png)

**What PH03C communicates:** the midpoint between the two equal, level front-pusher hubs visibly coincides with the centred rear mechanical-fan hub and vehicle/chassis centreline C0. The controlled upper cutaway exposes that normally hidden rear engine-driven puller and the three stacked heat exchangers. The black charge cooler shows its two large 57 mm charge-air elbows, the silver condenser shows two smaller refrigerant fittings, and the copper/brass radiator shows separate upper/lower engine-coolant necks plus filler/cap, overflow and drain service points. At both top corners, the original inward top-return plate and round hole remain in use; one vertical M8/washer stack passes through the hole and sleeved isolator into the independent black 4 mm ear, which continues directly to that radiator side rail. The lower saddle beneath the same rail carries radiator mass. **PH03C is illustrative and shall not be scaled; manufacture is controlled by D10/F1 at C0 − 133 mm and C0 + 133 mm, the physical samples, measured gates and full-size dummy.**

### 1.7 Existing-hole fastener detail

![PH04 — direct radiator side ear at one existing top-return hole](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_g_ph04_direct_side_ear_closeup.png)

### 1.8 Independent Relay/MIDI mounts
...
PH01–PH05 comprise seven AI design visualisations, not measured evidence. Do not scale them. PH01, PH02, PH04 and PH05 are retained Rev G layout references. PH03A is the normal opaque front appearance; PH03B is the complementary opaque engine-side view that honestly exposes the rear puller while hiding the grille-side pushers; PH03C is the controlled connection/centring cutaway. PH01 and PH02 account for exactly three fans in split and off-vehicle forms. PH03A and PH03B show how opacity changes which fan faces can be seen; together they do not replace a dimensioned drawing. PH03C accounts for the three core layers, six main circuit connections and large centred rear mechanical puller, and its cutaway is explanatory only. PH03C/PH04 show the required attachment logic: at each side, the same M8 through-bolt passes through the original frame top-return hole, sleeved EPDM isolator and short direct radiator ear; that ear fixes directly to its removable radiator side rail, with a weight-carrying lower saddle beneath. There is no transverse radiator carrier or intermediate bracket. PH05 is an electrical-placement proposal only. D08–D10, the actual vehicle, C0, physical boxes/cores, rigid two-hole template, full-size dummy and signed dimensions control manufacture.
...
|---|---|---|
| Engine radiator | Toyota HJ47/2H pattern; **530 W × 435 H × 64 D is the active-core thermal basis only**, not finished radiator size; exactly two main coolant necks plus filler/cap, overflow and lowest drain | Record R0 as complete W × H × D including tanks, seams, both necks, filler, overflow, drain, ears and lower locators. R0 must fit signed W0/H0-L/H0-R/P0 and the full-size dummy. If the active-core basis cannot be packaged inside R0, repackage and re-prove thermal duty; ≥115 kW continuous and ≥130 kW/10 min target |
| A/C condenser | Common 14 × 22 inch nominal R134a parallel-flow unit; 559 W × 356 H × 21 D basis; exactly two smaller refrigerant fittings, common #8 inlet / #6 outlet basis | Complete body, manifolds, both ports, ears and tool envelope fit inside M1/M2/M3; physical fittings and A/C test pass |
| Charge cooler | One new common bar-and-plate body exactly 500 W × 180 H × 50 D; exactly two 57 mm / 2.25 in beaded ports | Complete tanks, both ports and pipe bends remain between uprights; turbo-to-cooler-to-manifold route, ≥15 kW, ≤80°C IAT and ≤10 kPa route loss proven |
| Front electric fans | Two matched Prado 120/GX470-family Toyota/Denso 248 mm blades, motors, connectors and pigtails in one custom sealed shroud | Two ≥258 mm clear rings, exactly 266 mm motor C-C; centres C0 − 133 / C0 + 133 mm, pair midpoint within ±2 mm of C0 and same height within ±2 mm; ≥3,000 m³/h installed through all three cores |
...
|---|---|---|
| Radiator and coolant | Toyota HJ47/2H radiator pattern **16400-68030**, or sound original tanks recored; upper hose **16571-68020**; lower hose **16572-68020**; cap candidate **16401-41021**; Toyota-pattern constant-tension clamps | Provide exactly two main coolant necks and separate filler/cap, overflow and lowest drain. Copy physical neck centres/angles, verify engine/thermostat outlet → upper neck and lower neck → water-pump inlet, and verify cap seat/pressure |
| Front fan pair | Matched Toyota Prado 120 / Lexus GX470-family references: assemblies **88590-60040 / -60050 / -60051 / -60060**, motor **88550-12160**, blade **88453-60010**; published-equivalent blade diameter 248 mm | One shallow full-face, between-uprights sealed symmetric shroud with fan centres C0 ±133 mm; do not force-fit a donor shroud or offset the pair for another component |
...
| Charge-air core and pipe | If a Toyota/Denso charge-cooler sample is physically in hand, trial it against the stated envelope and duty; otherwise source a commonly serviceable bar-and-plate core to the same envelope and duty. Pakistan stock for this exact size is unconfirmed; the physical sample controls. Use 57 mm beaded aluminium/steel tube, silicone couplers and T-bolt clamps | Only measured pipe bends, support tabs, short sealing panels and brackets |
...
| C0 | Vehicle longitudinal centreline transferred from paired chassis/frame reference planes to the cooling aperture | Mark permanently on the rigid fixture and shroud template; do not derive from radiator, condenser, grille crop, photograph or electrical component |
...
1. Establish C0 from paired undamaged chassis/frame reference planes with a plumb line, laser or rigid bridge and transfer it to the aperture/fixture. Record the left and right measurements used.
2. Measure clear width between the upright inner faces at top, centre and bottom. The smallest value is M1.
3. Measure clear height with bonnet latch, grille and lower protection represented. The smallest value is M2.
4. Every complete part—not only its fin core—must fit M1/M2 with at least 5 mm hard clearance per side where movement can occur.
5. The 559 mm condenser basis requires at least 569 mm clear width including 5 mm per side. If the vehicle has less, select a narrower standard condenser; do not spread the uprights or notch a core.
6. The exact 530 mm radiator active-core width does not include tanks, seams, necks or ears. Measure the complete sample.
7. Keep the charge-cooler tanks and outlets inside the same upright control planes. Turn outlets rearward/inboard using gentle, bead-ended routes.
...
- Put both 248 mm motor centres at the same height within ±2 mm and exactly 266 mm apart. The left centre is **C0 − 133 mm** and the right centre is **C0 + 133 mm**; the measured pair midpoint must be within ±2 mm of C0.
- C0 comes from the car/chassis, not from the core or image. If the accepted 559 mm condenser body is centred on C0, its derived local x positions are 146.5 and 412.5 mm; if the accepted 530 mm active face is centred on C0, they are 132 and 398 mm. These local values are checks only—C0 controls.
- The fan pair may not be shifted to clear the drier, A/C manifold, charge-air pipes, Relay box, MIDI box or a radiator tank. Repackage those items around the centred shroud. If C0 ±133 mm cannot fit inside signed W0 with guards, plugs, clearances and service access, place F1 on HOLD and revise the package before fabrication.
...
![D10 — vehicle-centreline fan and physical-fit control](../data/manual/fabrication/front_cooling_stack_rev_c/work_document_assets/rev_h_d10_vehicle_centreline_control.png)

**D10 is the controlling front-fan drawing for Rev H.** It shows chassis-derived C0, the two hub coordinates at C0 − 133 mm and C0 + 133 mm, the exact 266 mm centre-to-centre spacing, the ±2 mm midpoint/height tolerances and the physical-fit HOLD boundary. D01–D09 remain retained Rev G layout references; where an older drawing appears to centre the fans on a core rather than the vehicle, D10 and the written C0 rule override it.
...
- Provide exactly two large main coolant necks: upper connection from the engine/thermostat outlet and lower connection back to the water-pump inlet. Copy the original/sample centres and angles; target neck OD is 38 mm only until the actual engine hoses are measured.
- Provide a separate filler/cap seat, small overflow nipple and lowest practical drain cock. These service points do not replace either main coolant neck.
...
- Provide exactly two beaded 57 mm ports, one at each end: turbo compressor discharge to cooler inlet, and cooler outlet to engine intake manifold. Mark intended airflow on the as-built pipes. Another verified size requires an approved revision.
...
- Provide exactly two separate refrigerant fittings. The common basis is #8 upper/high-side inlet from the compressor and #6 lower outlet to the receiver-drier; the actual new condenser and A/C technician control thread, side and final hose route.
...
Rev H has **exactly three fans**: two front electric pushers and the retained rear engine-driven mechanical puller. They serve all three cores. Do not fit a third electric fan or any additional fan in this release; a fan-count change requires a separately issued controlled revision before procurement or fabrication.
...
- If installed airflow is low, first seal bypasses, correct polarity/voltage drop and improve shrouds. Next select a lower-restriction standard core or better matched fan pair. Do not add another fan under Rev H; any fan-count change requires a separately issued controlled revision.
...
| C0 | Vehicle longitudinal centreline survey and transfer | Left/right chassis references recorded; C0 marked on aperture, rigid fixture and shroud template; independent of core/accessory position |
...
| F1 | Front twin-fan envelope and vehicle centring | Two equal 248 mm candidates; ≥258 mm rings; centres C0 − 133 / C0 + 133 mm; pair midpoint within ±2 mm of C0; same height within ±2 mm; no contact |
...
1. Establish and mark vehicle centreline C0 from paired chassis references. Confirm the existing post reference geometry (48 face / 410 upright / 58 return). Copy both original holes with one rigid 1:1 template and record C0/B0/H0-L/H0-R/W0/P0 plus M1–M5.
...
5. Stack the dummy in Rev H order. Set front fan centres at C0 − 133 and C0 + 133 mm, verify their midpoint and height tolerances, and confirm the complete assembly stays inside the posts.
...
- [Rev H Toyota-donor cooling-pack purchase list](j40-rev-h-toyota-donor-cooling-pack-purchase-list-20260801.md)
- [Rev H AI visual prompt and output record](../data/manual/fabrication/front_cooling_stack_rev_c/rev_h_cooling_pack_visual_prompts.md)
