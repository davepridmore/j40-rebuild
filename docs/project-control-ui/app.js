  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Mock the compact steel tray/stand with the battery and known component bases installed. Put the covered Relay Rev C tray on the outboard/access edge, keep MIDI and cutoff on separated top-front shelf zones, and prove direct cutoff-to-relay plus cutoff-to-MIDI cable bends and five MIDI output cables before cutting final ladder holes.",
      ...
      },
      {
        ...
        spec: "Widened steel access ladder for the measured front-cavity Relay Rev C tray pickup, separated MIDI/cutoff shelf pickups, protected cable support field, and MIDI five-output fanout.",
        qty: "1",
        dimension: "500 x 285 mm with rail-to-stand slots, outboard relay tray attachment slots, MIDI/cutoff shelf pickup holes, 80 mm cable-gutter clearance, MIDI five-output fanout clearance, and P-clip holes.",
        material: "3.0 mm mild steel.",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves relay cover access, direct relay/MIDI feeds, five-output MIDI cable bend clearance, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
