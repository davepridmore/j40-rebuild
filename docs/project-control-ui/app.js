  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Mock the compact steel tray/stand with the battery and known component bases installed. Put the covered Relay Rev C tray outside the battery footprint on the outboard/access edge, keep MIDI and cutoff on separated top-front shelf zones, and prove direct cutoff-to-relay plus cutoff-to-MIDI cable bends, three relay wire exits, battery lift-out, the attached MIDI output comb, and five MIDI output cables before cutting final ladder holes.",
        ...
        notes: "Current preferred route. Relay Rev C is already a folded tray, but the flat plastic rear guard/underlay sits before the folded metal tray and the covered relay box must face the access edge with upper, side, and lower wire exits clear. MIDI Rev C is an open plate/subplate with one common feed side, attached output comb, one enlarged double-wire output hole, and five output cables. Use the widened access-ladder placement unless the cavity map proves a smaller, clear, and serviceable alternative.",
      },
      {
        ...
        spec: "Widened steel access ladder for the measured front-cavity Relay Rev C tray pickup, separated MIDI/cutoff shelf pickups, protected cable support field, three relay exits, attached MIDI output comb, and MIDI five-output fanout.",
        qty: "1",
        dimension: "660 x 310 mm with rail-to-stand slots, outboard relay tray attachment slots, MIDI/cutoff shelf pickup holes, relay upper/side/lower wire-exit clearances, attached MIDI output comb, enlarged double-wire output hole, 80 mm cable-gutter clearance, MIDI five-output fanout clearance, and P-clip holes.",
        material: "3.0 mm mild steel.",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves relay cover access, three relay exits, direct relay/MIDI feeds, five-output MIDI cable bend clearance, enlarged double-wire output clearance, battery lift-out, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
      ...
      },
      {
        ...
        qty: "2 mirrored",
        dimension: "110 x 220 mm upright side plate; mock-up target 180 mm chassis-top-to-tray-underside rise with 150-210 mm vertical adjustment and 90-150 mm side-jog tuning.",
        material: "4.0 mm mild steel",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
