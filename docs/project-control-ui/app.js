  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Mock the compact steel tray/stand with the battery and known component bases installed. Start at 180 mm chassis-top-to-tray-underside rise and 120 mm wing-side/outboard tray-centre jog, then cut the formed chassis saddle, upright bridge, compact rail/tabs, and tray only after the one pickup point, bonnet clearance, switch depth, and cable bends are proven.",
      ...
      },
      {
        ...
        qty: "1",
        dimension: "325 x 120 mm with rail-to-stand slots, compact tray/bracket attachment slots, and P-clip holes.",
