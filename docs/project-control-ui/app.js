  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves relay cover access, relay top/front exits, battery-to-cutoff input routing, cutoff-to-relay and cutoff-to-MIDI switched feeds, five-output MIDI cable bend clearance through the seated comb and side gutter, enlarged double-wire output clearance, battery lift-out, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
