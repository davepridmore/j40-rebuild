  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        spec: "Widened steel access ladder for the measured front-cavity Relay Rev C tray pickup, battery-aligned separated MIDI/cutoff shelf pickups, protected cable support field, three sized relay exits, seated MIDI output comb/backplate, and MIDI five-output fanout.",
        qty: "1",
        dimension: "660 x 310 mm with rail-to-stand slots, outboard relay tray attachment slots, battery-aligned MIDI/cutoff shelf pickup holes, relay upper/side/lower wire-exit cluster clearances, seated MIDI output comb/backplate, enlarged double-wire output hole, 80 mm cable-gutter clearance, MIDI five-output fanout clearance, and P-clip holes.",
        material: "3.0 mm mild steel.",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves relay cover access, three sized relay exits, direct relay/MIDI feeds, five-output MIDI cable bend clearance through the seated comb, enlarged double-wire output clearance, battery lift-out, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
