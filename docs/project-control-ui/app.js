  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Mock the compact steel tray/stand with the battery and known component bases installed. Put the covered Relay Rev C tray outside the battery footprint on the outboard/access edge with about 80 mm relay-to-battery service gap, keep the kill switch beside the MIDI shelf instead of after the MIDI outputs, and prove battery-to-cutoff input routing, cutoff-to-relay and cutoff-to-MIDI switched cable bends, relay top/front exits, battery lift-out, the seated MIDI output comb/backplate, and five MIDI output cables before cutting final ladder holes.",
        ...
        notes: "Current preferred route. Relay Rev C is already a folded tray, but the flat plastic rear guard/underlay sits before the folded metal tray and the covered relay box is rotated so power input/output exits are at the top and control-cable exits face the front/radiator side. Battery positive enters the cutoff/kill switch first, then the cutoff output splits to the MIDI common-feed side and the relay input. MIDI Rev C is an open plate/subplate with seated output comb/backplate, one enlarged double-wire output hole, and five output cables. The cutoff/kill switch sits beside the MIDI shelf. Use the widened access-ladder placement unless the cavity map proves a smaller, clear, and serviceable alternative.",
      },
      {
        ...
        spec: "Widened steel access ladder for the measured front-cavity rotated Relay Rev C tray pickup, MIDI and side kill-switch shelf pickups, protected cable support field, relay top/front exits, cutoff-switched branch feeds, seated MIDI output comb/backplate, and MIDI five-output fanout.",
        qty: "1",
        dimension: "660 x 310 mm with rail-to-stand slots, outboard relay tray attachment slots, MIDI and side kill-switch shelf pickup holes, relay top power in/out clearances, relay front control-cable clearance, cutoff-output split cable clearance, seated MIDI output comb/backplate, enlarged double-wire output hole, 80 mm cable-gutter clearance, MIDI five-output fanout clearance, and P-clip holes.",
        material: "3.0 mm mild steel.",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves the shifted outboard tray/ladder position, about 80 mm relay-to-battery service gap, relay cover access, relay top/front exits, battery-to-cutoff input routing, cutoff-to-relay and cutoff-to-MIDI switched feeds, five-output MIDI cable bend clearance through the seated comb and side gutter, enlarged double-wire output clearance, battery lift-out, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
      ...
      },
      {
        ...
        qty: "2 mirrored",
        dimension: "110 x 220 mm upright side plate; mock-up target 180 mm chassis-top-to-tray-underside rise with 150-210 mm vertical adjustment and 120-180 mm side-jog tuning around a 150 mm wing-side/outboard tray shift from the more central chassis pickup.",
        material: "4.0 mm mild steel",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
