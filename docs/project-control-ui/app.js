  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Mock the compact steel tray/stand with the battery and known component bases installed. Put the covered Relay Rev C tray outside the battery footprint on the outboard/access edge, keep the kill switch beside the MIDI shelf instead of after the MIDI outputs, and prove direct battery-to-relay plus battery-to-MIDI cable bends, relay left/top exits, battery lift-out, the seated MIDI output comb/backplate, and five MIDI output cables before cutting final ladder holes.",
      ...
      },
      {
        ...
        spec: "Widened steel access ladder for the measured front-cavity Relay Rev C tray pickup, MIDI and side kill-switch shelf pickups, protected cable support field, relay left/top exits, seated MIDI output comb/backplate, and MIDI five-output fanout.",
        qty: "1",
        dimension: "660 x 310 mm with rail-to-stand slots, outboard relay tray attachment slots, MIDI and side kill-switch shelf pickup holes, relay left-side power in/out clearances, relay top control-cable clearance, seated MIDI output comb/backplate, enlarged double-wire output hole, 80 mm cable-gutter clearance, MIDI five-output fanout clearance, and P-clip holes.",
        material: "3.0 mm mild steel.",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves relay cover access, relay left/top exits, direct battery-to-relay and battery-to-MIDI feeds, five-output MIDI cable bend clearance through the seated comb and side gutter, enlarged double-wire output clearance, battery lift-out, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
