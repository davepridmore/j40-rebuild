  ...
  function buildScoutCategories() {
    ...
    const fabricationExactSpecRows = [
      ...
      },
      {
        ...
        action: "Mock the compact steel tray/stand with the battery and known component bases installed. Put the Relay Rev C tray in the raised front service field, keep MIDI and cutoff on separated top-front shelf zones, and prove direct cutoff-to-relay plus cutoff-to-MIDI cable bends before cutting final ladder holes.",
        ...
        notes: "Current preferred route. Relay Rev C is already a folded tray, but the flat plastic rear guard/underlay sits before the folded metal tray. MIDI Rev C is an open plate/subplate. Use the raised service-ladder placement unless the cavity map proves a smaller, clear, and serviceable alternative.",
      },
      {
        id: "BPCC-FRONT-RAIL-001",
        item: "Raised front service ladder",
        partNumber: "battery_power_compact_front_service_rail_rev_b.dxf",
        route: "battery_power_carrier_mount_rev_a",
        state: "cavity_map_required",
        image: scoutReferenceImage("../../data/manual/fabrication/battery_power_carrier_mount_rev_a/battery_power_compact_front_service_rail_rev_b.svg", "Raised front service ladder Rev B", "battery_power_compact_front_service_rail_rev_b"),
        spec: "Raised steel service ladder for the measured front-cavity Relay Rev C tray pickup, separated MIDI/cutoff shelf pickups, and protected cable support field.",
        qty: "1",
        dimension: "325 x 245 mm with rail-to-stand slots, raised relay tray attachment slots, MIDI/cutoff shelf pickup holes, cable-gutter clearance, and P-clip holes.",
        material: "3.0 mm mild steel.",
        sourceBasis: "data/manual/fabrication/battery_power_carrier_mount_rev_a/fabricator_cut_list.csv",
        action: "Use as cardboard template first; only release final metal if the front/radiator-side cavity map proves relay service access, cable bend clearance, and bonnet/radiator/hose clearance.",
      },
      {
        id: "BPCC-TRAY-001",
