...
- Active power-steering route is now an identified RHD J80 hydraulic steering-box conversion with matched sector/pitman hardware, a new measured J40-to-J80 frame reinforcement, collapsible shaft, measured drag link and physically verified 2H pump/bracket/pulley drive. No chassis plate, holes, sleeves, shaft work, battery-carrier lock or hydraulic routing is released until the actual parts pass full vehicle trial fit. See `docs/j80-hydraulic-power-steering-conversion-plan-20260802.md`.
...
- `Power steering gate`: the J80 hydraulic direction is selected, but fabrication remains blocked until the exact identified RHD J80 box, matched pitman/input parts, measured linkage/shaft and 2H pump drive pass bench inspection, pressure/flow matching and full vehicle trial fit.
