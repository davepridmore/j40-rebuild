...
- Stand/tray cardboard mock-up with standard `318 x 180 x 230 mm` battery envelope, central top terminals, removable hold-down, battery lift-out path, known Relay Rev C base rotated outside the battery footprint on the outboard/front access edge with about `80 mm` relay-to-battery service gap, plastic guard/underlay before the folded metal tray, relay top cutoff input and large power-output cluster, relay end-side input/cabin loom exit, MIDI Rev C holder bank on its separated top-front shelf with fuse 4 input, seated output comb/backplate and enlarged double-wire output hole, folded cutoff/kill-switch base/guard beside the MIDI shelf with far-side battery input, central battery-to-far-side-cutoff input path, near-side cutoff-to-relay and cutoff-to-MIDI branches, small-wire route under MIDI to relay top, five MIDI output cables, and cable lugs clears the bonnet, radiator, fan/belt, LHD steering shaft/box/service path, alternator service sweep, and cable bend radius.
...
8. Proposed relay/fuse/cutoff mock-up: widened access-ladder cards held with battery installed: `660 x 310 mm` service spine, `340 x 265 mm` tray and `318 x 180 x 230 mm` battery envelope with central terminals, rotated Relay Rev C `220 x 320 mm` outboard/front face outside the battery footprint, `185 x 280 mm` relay plastic rear guard/underlay before the folded metal tray, relay top cutoff input and large power-output cluster, relay end-side input/cabin loom exit, MIDI Rev C `190 x 150 mm` top-front shelf with fuse 4 input, seated output comb/backplate, one enlarged double-wire output access hole, and five output cables, folded cutoff/kill-switch base/guard `170 x 110 mm` finished face / `210 x 150 mm` flat pattern / `20 mm` upward lips beside the MIDI shelf with far-side battery input, central battery-to-far-side-cutoff and near-side cutoff-to-relay/MIDI cable lug sweeps, small-wire under-MIDI route to relay top, and the LHD steering-side no-go envelope.
