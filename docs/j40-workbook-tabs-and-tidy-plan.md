...
- `Parts` [cost_tracker] rows=234, cols=29, nonempty_rows=234, structured_rows=233
...
- `Build_Plan` [mixed_reference] rows=38, cols=8, nonempty_rows=38, structured_rows=37
