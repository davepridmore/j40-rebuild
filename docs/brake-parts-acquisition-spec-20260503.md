...
| --- | --- | --- |
| Front disc brake pad axle set | Required P0: 1 axle set for visible Sumitomo fixed-caliper setup | Reference pad family: `04491-60010`, `04491-60030`, `04465-35170`, `04465-YZZC0`; catalog Sumitomo pad shape is about `107 x 65.7 x 15.5 mm`. Active purchase row: `part_front_disc_pad_axle_set_sumitomo_20260530`. Buy only after removed pad outline, backing ears, pad thickness, rotor fit, and wheel clearance match the truck. |
| Front pad retaining hardware kit | Required P0: 1 front axle hardware kit, itemized at receipt | Reference hardware: `BR06158K` / `MT 12342`, with 4 pad pins, 2 anti-rattle springs, and 2 pin clips; Toyota hardware refs include `90240-06158`, `90468-12003`, `47748-60010`. Active purchase row: `part_front_disc_pad_pin_hardware_kit_sumitomo_20260530`. Buy only after removed retaining hardware matches. Count pins, springs, and clips separately on receipt. |
| Front pad shims / abutment pieces if fitted | Conditional sample-gated row | Photograph old pad backing/shim/abutment pieces after pad removal. Buy separately only if they are present and worn/missing, or if the selected pad kit requires separate shims/contact pieces. Do not add a generic shim kit without old-sample or mechanic release. |
