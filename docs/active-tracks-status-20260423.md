...
4. Track Ironman suspension delivery only; do not begin final install until the main kit, separate `24635FE x2` front damper pair, torque sheet, safe support setup, and chassis hanger checks are closed.
5. Hold interior finish stack (`WP05`) until body sealing gate closes.
6. Keep `WP06` reassembly blocked until body + electrical + mechanical + suspension gates are explicitly closed.
