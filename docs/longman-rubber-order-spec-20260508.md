...
| `EXH-HGR-90917` | Exhaust teardrop hanger cushion | Hold | Hold | Optional later item only if Longman can mould a rubber-metal teardrop cushion from sample/photo. Current target outline `48 x 86 mm`, top hole `9 mm`, lower hanger slot `16 x 22 mm`, thickness target `22 mm` unless sample proves otherwise. Toyota EPC-style exhaust references confirm FJ40 exhaust/muffler cushion hardware exists, and Toyota `90917-08004` is a known early exhaust/tail-pipe cushion lead, but those references do not release this vehicle's final geometry. | Needs old/genuine sample, installed support-point measurements, or a proper tracing before quoting production. | Heat/vibration-resistant exhaust-hanger rubber, Shore A `60 +/-5`. |
