...
| --- | --- | --- | --- |
| `part_fabrication_raw_mild_steel_plate_3mm_20260513` | Fabrication | `3.0 mm` mild-steel sheet/plate plus `90-degree` angle/L-section stock | 1 sheet at least `700 x 400 mm`; nearest stock size `600 x 600` or `1000 x 500` is acceptable. Add `25 x 25 x 3 mm` or `30 x 30 x 3 mm` mild-steel angle, `3 m` total, for tray/cassette rails and upstands. |
