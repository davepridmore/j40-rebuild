...
| `part_fabrication_raw_aluminium_plate_3mm_20260513` | Fabrication | `3.0 mm` 5052-H32 aluminium sheet | `500 x 500 mm` minimum for the current MIDI Rev D enclosure body/lid plus folded cutoff base/guard with `20 mm` upward lips. |
| `part_fabrication_raw_electrical_plastic_sheet_20260513` | Fabrication | `5.0 mm` electrical insulating board | `200 x 150 mm` minimum for the MIDI subplate. |
...
- Do not fabricate the battery stand from aluminium. The current route is steel for the compact tray, widened front/radiator access-ladder spine, top-front shelf/pickup tabs, formed chassis saddle, and upright bridge; the aluminium stock covers the MIDI Rev D enclosure body/lid and folded cutoff base/guard only.
