        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Trial-fit the formed chassis saddle, upright bridge, compact tray, widened access-ladder spine/tabs, outboard folded relay tray with plastic rear guard/underlay, sized relay exit clusters, battery-aligned top-front MIDI plate/subplate, battery-aligned top-front cutoff switch, seated MIDI output comb/backplate, engine/LHD keep-clear envelope, direct cable exits, and five MIDI output cables before wrapping or tying down the under-bonnet loom.",
                ],
        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Trial-fit electrical parts with the formed chassis saddle, upright bridge, spacers, direct cable exits, outboard covered relay base with plastic rear guard/underlay and sized relay exit clusters, battery-aligned top-front MIDI base/subplate, battery-aligned top-front cutoff switch, seated MIDI output comb/backplate, five MIDI output cables, and engine/LHD keep-clear envelope before tying down the loom.",
                ],
