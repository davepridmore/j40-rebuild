        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Mock the chassis pickup geometry from the May 14 no-battery image as a formed saddle over the rail: start tray underside 180 mm above chassis rail top, allow 150-210 mm vertical adjustment, set tray centre 120 mm wing-side/outboard from pickup centreline, and allow 90-150 mm side-jog adjustment.",
                    "Mock the widened front access-ladder cards from cardboard: 660 x 310 ladder, standard battery envelope 318 x 180 x 230 on a 340 x 265 tray with removable hold-down and lift-out path, Relay Rev C folded tray 320 x 220 outside the battery footprint on the outboard/access edge, relay plastic rear guard/underlay 280 x 185 ahead of the folded metal tray, left-side relay power input/output exits, top relay control-cable exit, MIDI Rev C open plate 190 x 150 on a separated top-front shelf started from the battery leading-edge datum with one common feed side, attached side-gutter output comb/backplate, one enlarged double-wire output hole, and five output cables, folded cutoff/kill-switch base/guard 170 x 110 finished face / 210 x 150 flat pattern / 20 mm upward lips beside the MIDI shelf, direct battery-to-relay and battery-to-MIDI cable lugs, 80 mm cable gutter, and depth blocks before final metal cutting.",
                    ...
                    "Trial-fit the formed chassis saddle, upright bridge, compact tray, widened access-ladder spine/tabs, outboard folded relay tray with plastic rear guard/underlay, relay left power in/out exits, relay top control-cable exit, battery-datum MIDI plate/subplate, side-mounted cutoff/kill switch beside the MIDI shelf, attached MIDI output comb/backplate and side gutter, engine/LHD keep-clear envelope, direct battery cable exits, and five MIDI output cables before wrapping or tying down the under-bonnet loom.",
                ],
        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Use the current chassis pickup mock-up estimate first as a formed saddle over the rail: tray underside 180 mm above chassis rail top, adjustable 150-210 mm; tray centre 120 mm wing-side/outboard from pickup centreline, adjustable 90-150 mm.",
                    "Trial-fit electrical parts with the formed chassis saddle, upright bridge, spacers, direct battery cable exits, outboard covered relay base with plastic rear guard/underlay plus left power in/out and top control-cable exits, battery-datum MIDI base/subplate, side-mounted cutoff/kill switch beside the MIDI shelf, attached MIDI output comb/backplate and side gutter, five MIDI output cables, and engine/LHD keep-clear envelope before tying down the loom.",
                ],
