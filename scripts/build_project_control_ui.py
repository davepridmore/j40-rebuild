        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Trial-fit the formed chassis saddle, upright bridge, compact tray, widened access-ladder spine/tabs, outboard folded relay tray with plastic rear guard/underlay, relay top power in/out exits, relay front control-cable exit, battery-datum MIDI plate/subplate, side-mounted cutoff/kill switch beside the MIDI shelf, attached MIDI output comb/backplate and side gutter, engine/LHD keep-clear envelope, battery-to-cutoff input path, cutoff-to-relay and cutoff-to-MIDI switched cable exits, and five MIDI output cables before wrapping or tying down the under-bonnet loom.",
                ],
        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Trial-fit electrical parts with the formed chassis saddle, upright bridge, spacers, battery-to-cutoff input path, cutoff-to-relay and cutoff-to-MIDI switched cable exits, outboard covered relay base with plastic rear guard/underlay plus top power in/out and front control-cable exits, battery-datum MIDI base/subplate, side-mounted cutoff/kill switch beside the MIDI shelf, attached MIDI output comb/backplate and side gutter, five MIDI output cables, and engine/LHD keep-clear envelope before tying down the loom.",
                ],
