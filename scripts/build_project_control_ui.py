        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Use data/manual/fabrication/battery_power_carrier_mount_rev_a/ for the current compact chassis-mounted battery stand and front/radiator-side service-cassette power carrier package.",
                    ...
                    "Mock the compact front-cassette cards from cardboard: 325 x 120 spine, Relay Rev C folded tray 320 x 220 low on the front face, MIDI Rev C open plate 190 x 150 on a top-front shelf, folded cutoff base/guard 170 x 110 finished face / 210 x 150 flat pattern / 20 mm upward lips at the top/front accessible corner, cable lugs, and depth blocks before final metal cutting.",
                    ...
                    "Trial-fit the formed chassis saddle, upright bridge, compact tray, front-cassette spine/tabs, low folded relay tray, top-front MIDI plate/subplate, top-front cutoff switch, engine/LHD keep-clear envelope, and cable exits before wrapping or tying down the under-bonnet loom.",
                ],
        ...
        "subtasks": [
            ...
            },
            {
                ...
                "process_steps": [
                    ...
                    "Use data/manual/fabrication/battery_power_carrier_mount_rev_a/ as the current compact chassis-mounted battery stand and front-cassette power carrier requirement.",
                    ...
                    "Trial-fit electrical parts with the formed chassis saddle, upright bridge, spacers, cable exits, low front relay base, top-front MIDI base/subplate, top-front cutoff switch, and engine/LHD keep-clear envelope before tying down the loom.",
                ],
...
FABRICATION_DESIGN_LINKS_BY_PACKAGE: dict[str, list[tuple[str, str]]] = {
    ...
    "battery_power_carrier_mount_rev_a": [
        ...
        ("data/manual/fabrication/battery_power_carrier_mount_rev_a/battery_power_compact_front_service_rail_rev_b.dxf", "Compact front service cassette spine DXF"),
